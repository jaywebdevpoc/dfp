...
class m160930_141452_dashboard_faq extends AmosMigration
{
    ...
    private function initWidgetsConfs()
    {
        $this->widgets = [
            ...
            [
                'classname' => open20\amos\faq\widgets\icons\WidgetIconFaq::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                'status' => AmosWidgets::STATUS_ENABLED,
                'child_of' => \open20\amos\faq\widgets\icons\WidgetIconFaqDashboard::className()
            ],
            [
                'classname' => open20\amos\faq\widgets\icons\WidgetIconFaqCategorie::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                'status' => AmosWidgets::STATUS_ENABLED,
                'child_of' => \open20\amos\faq\widgets\icons\WidgetIconFaqDashboard::className()
            ...
            [
                'classname' => open20\amos\faq\widgets\icons\WidgetIconFaqStati::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                'status' => AmosWidgets::STATUS_ENABLED,
                'child_of' => \open20\amos\faq\widgets\icons\WidgetIconFaqDashboard::className()
