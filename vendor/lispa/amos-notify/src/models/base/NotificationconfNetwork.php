 ...
 */
class  NotificationconfNetwork extends \lispa\amos\core\record\Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['models_classname_id'], 'exist', 'skipOnError' => true, 'targetClass' => \lispa\amos\core\models\ModelsClassname::className(), 'targetAttribute' => ['models_classname_id' => 'id']],
        ];
    }
