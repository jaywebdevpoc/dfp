...
<div id="container-nofification-enabled" style="display:none">
    ...
    <div class="form-group col-xs-12">
        <div class="checkbox">
            <?php echo \lispa\amos\core\helpers\Html::activeCheckbox($widget->model, 'notify_from_editorial_staff', [
    ...
    if (!empty($dataProviderNetwork)) {
        ...
        echo \lispa\amos\core\views\AmosGridView::widget([
            ...
            'columns' => [
                'logo_id' => [
                    'headerOptions' => [
                        'id' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Logo'),
                    ],
                    'contentOptions' => [
                        'headers' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Logo'),
                    ],
                    'label' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Logo'),
                    'format' => 'raw',
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        return Html::a($model->name, ['/community/community/view', 'id' => $model->id], [
                            'title' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Apri il profilo della community {community_name}', ['community_name' => $model->name])
                        ]);
                    }
                ],
                'communityType' => [
                    ...
                    'value' => function ($model) {
                        ...
                        if (!is_null($model->community_type_id)) {
                            return \lispa\amos\community\AmosCommunity::t('amoscommunity', $model->communityType->name);
                        } else {
                            return '-';
                        }
                    }
...
//                            $creator = \lispa\amos\core\user\User::findOne($model->created_by);
//                            if(!empty($creator)) {
...
//                'status' => [
//                    'attribute' => 'status',
//                    'label' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Status'),
//                    'headerOptions' => [
//                        'id' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Status'),
//                    ],
//                    'contentOptions' => [
//                        'headers' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Status'),
//                    ],
//                    'value' => function($model)use ($widget){
//                        /** @var Community $model */
//                        $mmrow = \lispa\amos\community\models\CommunityUserMm::findOne(['user_id' => $widget->model->user_id, 'community_id' => $model->id]);
//                        return  $mmrow->status;
//                    }
//                ],
//                'role' => [
//                    'attribute' => 'role',
//                    'label' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Role'),
//                    'headerOptions' => [
//                        'id' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Role'),
//                    ],
//                    'contentOptions' => [
//                        'headers' => \lispa\amos\community\AmosCommunity::t('amoscommunity', 'Role'),
//                    ],
//                    'value' => function($model) use ($widget){
//                        /** @var Community $model */
//                        $mmrow = \lispa\amos\community\models\CommunityUserMm::findOne(['user_id' =>  $widget->model->user_id, 'community_id' => $model->id]);
