...
use lispa\amos\report\widgets\ReportDropdownWidget;

$asset = BaseAsset::register($this);

$moduleCommunity = Yii::$app->getModule('community');
if (isset($community)) {
    lispa\amos\community\assets\AmosCommunityAsset::register($this);
...
<!--                                        'layout' => '@vendor/lispa/amos-layout/src/views/widgets/context_menu_widget_network_scope.php'-->
<!--                                    ]) ?>-->
<!--                                </div>-->
                            <?php
                            else:
                                ...
                                <?php if (\Yii::$app->user->can('COMMUNITY_UPDATE',
                                        ['model' => $community])) : ?>
                                    <?=
                                    Html::a(\lispa\amos\core\icons\AmosIcons::show('modifica', [],
                                            \lispa\amos\core\icons\AmosIcons::IC),
