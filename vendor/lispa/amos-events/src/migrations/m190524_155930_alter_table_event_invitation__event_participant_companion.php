...
class m190524_155930_alter_table_event_invitation__event_participant_companion extends Migration
{
    ...
    {
        $this->dropColumn(\lispa\amos\events\models\EventInvitation::tableName(), 'presenza_scansionata_il');
        $this->dropColumn(\lispa\amos\events\models\EventParticipantCompanion::tableName(), 'presenza_scansionata_il');
    }
