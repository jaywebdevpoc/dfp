 ...
 *
 *
 * @package    lispa\amos\events\widgets\graphics\views\fullsize
...
use lispa\amos\events\widgets\graphics\WidgetGraphicsEvents;
 ...
 * @var \lispa\amos\events\models\Event[] $eventsForCarousel
            ...
            <div class="<?= ($thereAreEvents ? 'col-sm-8' : '') ?> col-xs-12 nop" id="event-calendar-pjax">
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($eventsForCarousel as $event): ?>
                        <?php /** @var \lispa\amos\events\models\Event $event */ ?>
                        <div>
