 ...
 * @package lispa\amos\events\models
 */
class Event extends \lispa\amos\events\models\base\Event implements ContentModelInterface, CommunityContextInterface, CommentInterface, ViewModelInterface, SeoModelInterface
{
    /**
