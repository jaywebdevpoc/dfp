 ...
 *
 * @property \lispa\amos\events\models\Event $event
 * @property EventInvitation $partnerOf
 * @property EventInvitation[] $eventInvitations
 */
class EventInvitation extends \lispa\amos\core\record\Record
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            [['partner_of'], 'exist', 'skipOnError' => true, 'targetClass' => \lispa\amos\core\user\User::className(), 'targetAttribute' => ['partner_of' => 'id']],
        ];
    }
