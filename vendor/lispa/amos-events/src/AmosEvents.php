...
use lispa\amos\events\widgets\icons\WidgetIconEventsCreatedBy;
use lispa\amos\events\widgets\icons\WidgetIconEventsManagement;
use lispa\amos\events\widgets\icons\WidgetIconEventsToPublish;
use lispa\amos\events\widgets\icons\WidgetIconEventTypes;
use lispa\amos\events\widgets\InviteUserToEventWidget;
...
class AmosEvents extends AmosModule implements ModuleInterface, SearchModuleInterface, CmsModuleInterface
{
    ...
    public $db_fields_translation = [
        [
            'namespace' => 'lispa\amos\events\models\EventType',
            'attributes' => ['title'],
            'category' => 'amosevents',
        ],
    ];
    ...
    public $viewPathEmailSummary = [
        'lispa\amos\events\models\Event' => '@vendor/lispa/amos-events/src/views/email/notify_summary'
    ];

    public $viewPathEmailSummaryTitle = [
        'lispa\amos\events\models\Event' => '@vendor/lispa/amos-events/src/views/email/notify_summary_title'
    ];
    ...
    /**
     * @param \lispa\amos\admin\models\UserProfile $model
     * @return string
     * @throws \Exception
     */
