...
use lispa\amos\events\models\EventInvitation;
use lispa\amos\events\models\EventInvitationsUpload;
use lispa\amos\events\models\EventLengthMeasurementUnit;
use lispa\amos\events\models\EventParticipantCompanion;
use lispa\amos\events\models\EventParticipantCompanionDynamic;
use lispa\amos\events\models\EventSeats;
use lispa\amos\events\models\EventType;
use lispa\amos\events\models\FormAssignSeat;
use lispa\amos\events\models\RegisterGroupForm;
use lispa\amos\events\rules\EventsCheckInRule;
use lispa\amos\events\rules\EventsUpdateRule;
use lispa\amos\events\utility\EventsUtility;
use lispa\amos\events\utility\ICS;
use lispa\amos\events\utility\MultipleModel;
use kartik\mpdf\Pdf;
...
class EventController extends base\EventController
{
    ...
    public function actionDownloadImportFileExample(){
        $path = Yii::getAlias('@vendor') . '/lispa/amos-events/src/downloads';
