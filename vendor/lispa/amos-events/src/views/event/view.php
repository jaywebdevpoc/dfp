...
use lispa\amos\core\forms\editors\socialShareWidget\SocialShareWidget;
...
use lispa\amos\events\widgets\CommunityEventMembersWidget;
                    ...
                    <div class="col-xs-12">
                        ...
                        if (EventsUtility::checkManager($model)) {
                            ...
                            if ($invitation && !empty($invitation)) {
                                echo ($invitation->everyoneInSameInvitationHasAccreditationList()
                                        ? Html::a(
    ...
    <?php if ($model->seats_management && EventsUtility::hasPrivilegesLoggedUser($model)) { ?>
        ...
        <div class="attachments col-xs-12 nop">
            ...
            $totEmptySeats = $model->getEventSeats()
                ->andWhere(['status' => [EventSeats::STATUS_EMPTY, \lispa\amos\events\models\EventSeats::STATUS_TO_REASSIGN]])->count();
            ?>
