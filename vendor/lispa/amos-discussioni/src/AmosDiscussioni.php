...
class AmosDiscussioni extends AmosModule implements ModuleInterface, SearchModuleInterface, CmsModuleInterface
{
    ...
    // @var string $controllerNamespace the controller namespace
        $controllerNamespace = 'lispa\amos\discussioni\controllers',
    ...
    public function bootstrap($app)
    {
        if ($app instanceof Application) {
            $this->controllerNamespace = 'lispa\amos\discussioni\commands\controllers';
    ...
    public function init()
    {
        ...
        if (\Yii::$app instanceof Application) {
            \Yii::setAlias('@lispa/amos/' . static::getModuleName() . '/commands', __DIR__ . '/commands/');
