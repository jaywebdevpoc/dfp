...
class m160930_141439_permission_role_faq extends AmosMigration
{
    ...
    protected function setAuthorizations()
    {
        $this->authorizations = [
            ...
            [
                'name' => \lispa\amos\faq\widgets\icons\WidgetIconFaq::className(),
            ...
            [
                'name' => \lispa\amos\faq\widgets\icons\WidgetIconFaqCategorie::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => 'Permesso sul widget IconFaq',
                'ruleName' => null,
                'parent' => ['AMMINISTRATORE_FAQ']
            ...
            [
                'name' => \lispa\amos\faq\widgets\icons\WidgetIconFaqStati::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => 'Permesso sul widget IconFaq',
                'ruleName' => null,
                'parent' => ['AMMINISTRATORE_FAQ']
            ...
            [
                'name' => \lispa\amos\faq\widgets\icons\WidgetIconFaqDashboard::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => 'Permesso sul widget IconFaq',
                'ruleName' => null,
                'parent' => ['AMMINISTRATORE_FAQ']
