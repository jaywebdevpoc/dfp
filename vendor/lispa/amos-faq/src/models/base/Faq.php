 ...
 *
 * @property \lispa\amos\faq\models\FaqCategories $faqCategories
 * @property \lispa\amos\faq\models\FaqStato $faqStato
 * @property \lispa\amos\faq\models\FaqWidgets $faqWidgets
 */
class Faq extends Record
{
    ...
    {
        return $this->hasOne(\lispa\amos\faq\models\FaqCategories::className(), ['id' => 'faq_categories_id']);
    }
    ...
    {
        return $this->hasOne(\lispa\amos\faq\models\FaqStato::className(), ['id' => 'faq_stato_id']);
    }
