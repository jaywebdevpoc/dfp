        ...
        <div class="sidebar col-sm-5 col-xs-12">
            <div class="container-sidebar">
                ...
                <?php if ($documentLinkPresent): ?>
                    <div class="box">
                       <?php
                        echo AmosIcons::show('doc-www', ['class' => 'am-4'], 'dash') . Html::tag('p', \lispa\amos\core\utilities\StringUtils::shortText($model->titolo, 80) , ['class' => 'title']);
                        ?>

                        <?php
                        echo  Html::tag('p', \lispa\amos\core\utilities\StringUtils::shortText($model->link_document, 50) , ['class' => 'title']);
                        ?>
