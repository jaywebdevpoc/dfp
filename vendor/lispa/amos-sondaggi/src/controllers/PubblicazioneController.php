...
//                foreach ($domandeWithFilesModels as $doma
                                            ...
                                            $attivita = null, $inizio = false, $libero = false)
    {
        ...
        if ($libero && $id) {
            $verificaSondaggio = \lispa\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
    ...
    {
        $this->layout = '@vendor/lispa/amos/core/views/layouts/sondaggio';
        $models       = \lispa\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
        ...
        if ($id) {
            $verifica = \lispa\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
                    'id = sondaggi_id')->andWhere(['id' => $id])->andWhere(['tipologie_attivita' => 0])->andWhere(['status' => Sondaggi::WORKFLOW_STATUS_VALIDATO])->andWhere([
                'ruolo' => 'PUBBLICO']);
            if ($verifica->count() == 1) {
