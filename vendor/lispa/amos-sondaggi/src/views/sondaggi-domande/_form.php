...
use yii\helpers\Url;
use lispa\amos\sondaggi\models\SondaggiMap;
            ...
            $form->field($model, 'introduzione')->widget(TextEditorWidget::className(),
                ...
                'clientOptions' => [
                    'placeholder' => AmosSondaggi::t('amossondaggi',
                        'Qui si può inserire una descrizione introduttiva alla domanda'),
    ...
    <div class="row sondaggio-row">
        <div class="col-lg-6 col-sm-6">
            ...
            $form->field($model, 'sondaggi_domande_tipologie_id')->dropDownList(
                \yii\helpers\ArrayHelper::map(\lispa\amos\sondaggi\models\SondaggiDomandeTipologie::find()->andWhere([
        ...
        <div class="col-lg-6 col-sm-6">
            ...
            if ($model->sondaggi_id) :
                ...
                $form->field($model, 'sondaggi_id')->widget(Select2::classname(),
                    [
                    'data' => ArrayHelper::map(\lispa\amos\sondaggi\models\Sondaggi::find()->asArray()->all(),
                        'id', 'titolo'),
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-sm-9">
            ...
            $form->field($model, 'condizione_necessaria')->dropDownList(
                yii\helpers\ArrayHelper::map($model->getTutteDomandeDellaPagina()->all(), 'id', 'risposta', 'domanda'),
                ['prompt' => AmosSondaggi::t('amossondaggi', 'Seleziona ...'), 'id' => 'condizione_necessaria-id']
            )
            ?>
            <?php /*
