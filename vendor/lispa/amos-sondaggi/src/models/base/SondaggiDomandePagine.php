...
class SondaggiDomandePagine extends \lispa\amos\core\record\Record
{
    ...
    public function getSondaggiDomandes()
    {
        return $this->hasMany(\lispa\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_domande_pagine_id' => 'id'])
            ->andWhere([\lispa\amos\sondaggi\models\SondaggiDomande::tableName().'.deleted_at' => null]);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_domande_pagine_id' => 'id'])->andWhere(['OR', ['sondaggi_domande_tipologie_id' => 10], ['sondaggi_domande_tipologie_id' => 11]]);;
    }
