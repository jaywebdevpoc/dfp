<?php
/**
 * This IS A FORK of bedezign yii2 audit to customize it for lispa requests
 * 
...
use lispa\amos\audit\components\panels\Panel;
...
class Audit extends Module
{
    ...
    private $_corePanels = [
        ...
        'audit/request'    => ['class' => 'lispa\amos\audit\panels\RequestPanel'],
        'audit/db'         => ['class' => 'lispa\amos\audit\panels\DbPanel'],
        'audit/log'        => ['class' => 'lispa\amos\audit\panels\LogPanel'],
        'audit/asset'      => ['class' => 'lispa\amos\audit\panels\AssetPanel'],
        'audit/config'     => ['class' => 'lispa\amos\audit\panels\ConfigPanel'],
        'audit/profiling'  => ['class' => 'lispa\amos\audit\panels\ProfilingPanel'],

        // Special other panels
        'audit/error'      => ['class' => 'lispa\amos\audit\panels\ErrorPanel'],
        'audit/javascript' => ['class' => 'lispa\amos\audit\panels\JavascriptPanel'],
        'audit/trail'      => ['class' => 'lispa\amos\audit\panels\TrailPanel'],
        'audit/mail'       => ['class' => 'lispa\amos\audit\panels\MailPanel'],
        'audit/extra'      => ['class' => 'lispa\amos\audit\panels\ExtraDataPanel'],
        'audit/curl'       => ['class' => 'lispa\amos\audit\panels\CurlPanel'],
        'audit/soap'       => ['class' => 'lispa\amos\audit\panels\SoapPanel'],
    ];
    ...
    /**
     * @var \lispa\amos\audit\models\AuditEntry If activated this is the active entry
     */
    private $_entry = null;
