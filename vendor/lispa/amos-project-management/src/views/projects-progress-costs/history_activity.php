...
<div class="projects-progress-costs-index">
    ...
    if ($dataProvider->totalCount <= 0):
        echo Module::t('amosproject_management', 'There are no previous costs for the progress of this activity');
    else:
        try {
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            ...
                            try {
                                return $model->projectsProgressCostsType->nameTranslate;
                            } catch (Exception $e) {
                                return '';
                            }
                        }
    ...
    ?>
    <?= \lispa\amos\core\forms\CloseButtonWidget::widget(['urlClose' => \yii\helpers\Url::previous() . '#costs']); ?>
