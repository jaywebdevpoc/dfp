...
$this->params['breadcrumbs'][] = ['label' => Yii::t('amosproject_management', 'Projects Progress Costs'), 'url' => ['index']];
                    ...
                    'value' => function ($model) use ($detectionPeriod) {
                        try {
                            ...
                            if ($model->getClassPath() == \lispa\amos\projectmanagement\models\ProjectsTasks::className()) {
                                ...
                                $projectCost = $model->getProgressCostOfDetection($detectionPeriod->id);
                                try {
                ...
                [
                    ...
                    'value' => function ($model)use ($detectionPeriod) {
                        try {
                            ...
                            if ($model->getClassPath() == \lispa\amos\projectmanagement\models\ProjectsTasks::className()) {
                                // $model now is Task
                                $projectStatement = $model->getProgressCostOfDetection($detectionPeriod->id);
