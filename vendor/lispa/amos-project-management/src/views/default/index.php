...
<div id="dashboard-edit-toolbar" class="hidden">
    <?=
    Html::a(Module::t('amosproject_management', 'Salva'), 'javascript:void(0);', [
    ...
    <?=
    Html::a(Module::t('amosproject_management', 'Annulla'), \yii\helpers\Url::current(), [
    ...
    <div class="actions-dashboard-container">
        <ul id="widgets-icon" class="bk-sortableIcon plugin-list"
            ...
            if ($thisDashboardWidgets && count($thisDashboardWidgets) > 0) {
                ...
                AmosDashboard::t('amosproject_management', 'Non ci sono widgets selezionati per questa dashboard');
            }
            ?>
        </ul>
    </div>
