...
/**
 * This is the model class for table "projects_projects_states_mm".
 */
class ProjectsProjectsStatesMm extends \lispa\amos\projectmanagement\models\base\ProjectsProjectsStatesMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsprojectsstatesmmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsprojectsstatesmmQuery = new ProjectsprojectsstatesmmQuery(get_called_class());
    $ProjectsprojectsstatesmmQuery->andWhere('projectsprojectsstatesmm.deleted_at IS NULL');
    return $ProjectsprojectsstatesmmQuery;
    }
    */
