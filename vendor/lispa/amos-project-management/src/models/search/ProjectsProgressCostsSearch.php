 ...
 */
class ProjectsProgressCostsSearch extends ProjectsProgressCosts
{
    public function rules()
    {
        return [
            [['id', 'projects_progress_cost_type_id', 'projects_progress_detection_period_id', 'projects_task_id', 'user_responsible_id', 'organization_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
    ...
    {
        $query = ProjectsProgressCosts::find();
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'projects_progress_cost_type_id' => $this->projects_progress_cost_type_id,
