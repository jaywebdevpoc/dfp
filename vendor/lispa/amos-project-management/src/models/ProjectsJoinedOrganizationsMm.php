...
/**
 * This is the model class for table "projects_joined_organization_mm".
 */
class ProjectsJoinedOrganizationsMm extends \lispa\amos\projectmanagement\models\base\ProjectsJoinedOrganizationsMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsJoinedOrganizationsMmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsJoinedOrganizationsMmQuery = new ProjectsJoinedOrganizationsMmQuery(get_called_class());
    $ProjectsJoinedOrganizationsMmQuery->andWhere('ProjectsJoinedOrganizationsMm.deleted_at IS NULL');
    return $ProjectsJoinedOrganizationsMmQuery;
    }
    */
