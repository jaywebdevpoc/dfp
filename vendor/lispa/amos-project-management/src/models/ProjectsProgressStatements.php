...
use lispa\amos\projectmanagement\events\ProjectsProgressStatementsWorkflowEvent;
...
/**
 * This is the model class for table "projects_progress_statements".
 */
class ProjectsProgressStatements extends \lispa\amos\projectmanagement\models\base\ProjectsProgressStatements implements CommentInterface, ModelLabelsInterface, ViewModelInterface
{
    ...
    public function init()
    {
        ...
        $this->on('afterChangeStatusFrom{' . self::PROJECTSACTIVITYPROGRESS_WORKFLOW_STATUS_CONFIRMED . '}to{' . self::PROJECTSACTIVITYPROGRESS_WORKFLOW_STATUS_ONEDIT . '}', [new ProjectsProgressStatementsWorkflowEvent(), 'afterChangeStatusFromConfirmedToOnEdit'], $this);
        $this->on('afterChangeStatusFrom{' . self::PROJECTSACTIVITYPROGRESS_WORKFLOW_STATUS_ONEDIT . '}to{' . self::PROJECTSACTIVITYPROGRESS_WORKFLOW_STATUS_CONFIRMED . '}', [new ProjectsProgressStatementsWorkflowEvent(), 'afterChangeStatusFromOnEditToConfirmed'], $this);
    ...
    public static function getEditFields()
    {
        ...
        return [
            ...
            [
                'slug' => 'projects_progress_statements_type_id',
                'label' => $labels['projects_progress_statements_type_id'],
                'type' => 'integer'
            ],
            [
    ...
    {
        return 'project_management/projects-progress-statements/view';
    }
    ...
    {
        return Url::toRoute(["/project_management/projects/by-project", "id" => $this->projectsTask->project->id, '#' => 'statements']);
    }
    ...
    {
        return new ProjectsProgressStatementsGrammar();
    }
