...
/**
 * This is the base-model class for table "projects_progress_costs".
 *
 * @property integer $id
 * @property string $status
 * @property string $note
 * @property integer $projects_progress_cost_type_id
 ...
 * @property \lispa\amos\projectmanagement\models\ProjectsProgressCostsType $projectsProgressCostsType
 * @property User $userResponsible
 */
class ProjectsProgressCosts extends \lispa\amos\core\record\Record
{
    ...
    {
        return 'projects_progress_costs';
    }
    ...
    public function rules()
    {
        return [
            [['note'], 'string'],
            [['projects_progress_cost_type_id', 'projects_progress_detection_period_id', 'projects_task_id', 'user_responsible_id', 'organization_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
            ...
            [['projects_progress_cost_type_id'], 'exist', 'skipOnError' => true, 'targetClass' => ProjectsProgressCostsType::className(), 'targetAttribute' => ['projects_progress_cost_type_id' => 'id']],
            [['user_responsible_id'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['user_responsible_id' => 'id']],
            [['projects_progress_cost_type_id', 'note'], 'required'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'projects_progress_cost_type_id' => Yii::t('amosproject_management', 'FK to projects_progress_costs_type'),
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getProjectsProgressCostsType()
    {
        return $this->hasOne(\lispa\amos\projectmanagement\models\ProjectsProgressCostsType::className(), ['id' => 'projects_progress_cost_type_id']);
    }
