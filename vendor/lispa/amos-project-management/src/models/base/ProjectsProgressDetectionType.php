...
/**
 * This is the base-model class for table "projects_progress_detection_type".
 *
 * @property integer $id
 ...
 */
class ProjectsProgressDetectionType extends \lispa\amos\core\record\Record
{
    ...
    {
        return 'projects_progress_detection_type';
    }
