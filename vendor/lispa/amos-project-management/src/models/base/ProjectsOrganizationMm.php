...
/**
 * This is the base-model class for table "projects_organization_mm".
 *
 * @property integer $id
 ...
 */
class ProjectsOrganizationMm extends \lispa\amos\core\record\Record
{
    ...
    {
        return 'projects_organization_mm';
    }
    ...
    {
        return $this->hasOne($this->organizationModelClass, ['id' => 'organization_id'])->inverseOf('projectsOrganizationMms');
    }
    ...
    public function getProjects()
    {
        return $this->hasOne(\lispa\amos\projectmanagement\models\Projects::className(),
            ['id' => 'projects_id'])->inverseOf('projectsOrganizationMms');
    }
}
