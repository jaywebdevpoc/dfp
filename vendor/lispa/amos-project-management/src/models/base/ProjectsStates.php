 ...
 */
class ProjectsStates extends \lispa\amos\core\record\Record
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(\lispa\amos\projectmanagement\models\ProjectsProjectsStatesMm::className(),
            ['projects_states_id' => 'id'])->inverseOf('projectsStates');
    }
}
