...
/**
 * This is the model class for table "projects_tasks_projects_task_statuses_mm".
 */
class ProjectsTasksProjectsTaskStatusesMm extends \lispa\amos\projectmanagement\models\base\ProjectsTasksProjectsTaskStatusesMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectstasksprojectstaskstatusesmmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectstasksprojectstaskstatusesmmQuery = new ProjectstasksprojectstaskstatusesmmQuery(get_called_class());
    $ProjectstasksprojectstaskstatusesmmQuery->andWhere('projectstasksprojectstaskstatusesmm.deleted_at IS NULL');
    return $ProjectstasksprojectstaskstatusesmmQuery;
    }
    */
