...
/**
 * This is the model class for table "projects_projects_measure_mm".
 */
class ProjectsProjectsMeasureMm extends \lispa\amos\projectmanagement\models\base\ProjectsProjectsMeasureMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsprojectsmeasuremmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsprojectsmeasuremmQuery = new ProjectsprojectsmeasuremmQuery(get_called_class());
    $ProjectsprojectsmeasuremmQuery->andWhere('projectsprojectsmeasuremm.deleted_at IS NULL');
    return $ProjectsprojectsmeasuremmQuery;
    }
    */
