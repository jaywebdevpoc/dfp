...
/**
 * This is the model class for table "projects_activities_projects_mm".
 */
class ProjectsActivitiesProjectsMm extends \lispa\amos\projectmanagement\models\base\ProjectsActivitiesProjectsMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsactivitiesprojectsmmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsactivitiesprojectsmmQuery = new ProjectsactivitiesprojectsmmQuery(get_called_class());
    $ProjectsactivitiesprojectsmmQuery->andWhere('projectsactivitiesprojectsmm.deleted_at IS NULL');
    return $ProjectsactivitiesprojectsmmQuery;
    }
    */
