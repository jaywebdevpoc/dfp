...
/**
 * This is the model class for table "projects_organization_mm".
 */
class ProjectsOrganizationMm extends \lispa\amos\projectmanagement\models\base\ProjectsOrganizationMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsOrganizationMmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsOrganizationMmQuery = new ProjectsOrganizationMmQuery(get_called_class());
    $ProjectsOrganizationMmQuery->andWhere('ProjectsOrganizationMm.deleted_at IS NULL');
    return $ProjectsOrganizationMmQuery;
    }
    */
