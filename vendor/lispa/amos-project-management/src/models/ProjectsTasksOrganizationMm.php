...
/**
 * This is the model class for table "projects_tasks_organization_mm".
 */
class ProjectsTasksOrganizationMm extends \lispa\amos\projectmanagement\models\base\ProjectsTasksOrganizationMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectsTasksOrganizationMmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectsTasksOrganizationMmQuery = new ProjectsTasksOrganizationMmQuery(get_called_class());
    $ProjectsTasksOrganizationMmQuery->andWhere('ProjectsTasksOrganizationMm.deleted_at IS NULL');
    return $ProjectsTasksOrganizationMmQuery;
    }
    */
