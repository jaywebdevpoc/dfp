...
/**
 * This is the model class for table "projects_tasks_projects_activities_mm".
 */
class ProjectsTasksProjectsActivitiesMm extends \lispa\amos\projectmanagement\models\base\ProjectsTasksProjectsActivitiesMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe ProjectstasksprojectsactivitiesmmQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $ProjectstasksprojectsactivitiesmmQuery = new ProjectstasksprojectsactivitiesmmQuery(get_called_class());
    $ProjectstasksprojectsactivitiesmmQuery->andWhere('projectstasksprojectsactivitiesmm.deleted_at IS NULL');
    return $ProjectstasksprojectsactivitiesmmQuery;
    }
    */
