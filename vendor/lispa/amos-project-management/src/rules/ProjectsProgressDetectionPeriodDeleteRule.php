...
class ProjectsProgressDetectionPeriodDeleteRule extends Rule
{

    public $name = 'projectsProgressDetectionPeriodDelete';
    ...
    public function execute($user, $item, $params)
    {
        ...
        if (count($model->projectsProgressCosts) > 0) {
            return false;
        }

        if (count($model->projectsProgressStatements) > 0) {
            return false;
        }
