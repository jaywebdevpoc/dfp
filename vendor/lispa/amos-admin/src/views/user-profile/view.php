    ...
    <div class="col-xs-12 info-view-header nop">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            ...
            <section class="wrap-details">
                ...
                <?php
                if(class_exists('\lispa\amos\community\models\CommunityUserField')){
                    $fields = \lispa\amos\community\utilities\CommunityUserFieldUtility::getCommunityUserFieldValues();
