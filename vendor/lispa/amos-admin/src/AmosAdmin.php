...
class AmosAdmin extends AmosModule implements SearchModuleInterface
{
     ...
     * @var string
     */
    public $htmlMailNotifyAcceptedRegistrationRequestContent = '@vendor/lispa/amos-admin/src/mail/user/notify-accepted-registration-request-html';

    /**
     * This is the html subject used to render the message of the e-mail send to user that had invited someone
     * @var string
     */
    public $htmltMailNotifyAcceptedRegistrationRequestSubject = '@vendor/lispa/amos-admin/src/mail/user/notify-accepted-registration-request-subject';
