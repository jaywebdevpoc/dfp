...
class UserProfileSearch extends UserProfile implements SearchModelInterface {
    ...
    public function searchCommunityManagerUsers($params) {
        ...
        if (!is_null($communityModule)) {
            ...
            $queryAll->andWhere(['<>', $communityTableName . '.community_type_id', \lispa\amos\community\models\CommunityType::COMMUNITY_TYPE_CLOSED]);
            ...
            $managerQuery->andWhere(['<>', $communityTableName . '.community_type_id', \lispa\amos\community\models\CommunityType::COMMUNITY_TYPE_CLOSED]);
