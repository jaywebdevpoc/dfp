 ...
 * @property \lispa\amos\community\models\CommunityFieldType $fieldType
 * @property \lispa\amos\community\models\CommunityUserFieldVal[] $communityUserFieldVals
 */
class  CommunityUserField extends \lispa\amos\core\record\Record
{
    ...
    {
        return $this->hasOne(\lispa\amos\community\models\CommunityUserFieldType::className(), ['id' => 'user_field_type_id']);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\community\models\CommunityUserFieldVal::className(), ['user_field_id' => 'id'])->andWhere(['user_id' => $user_id]);
    }
