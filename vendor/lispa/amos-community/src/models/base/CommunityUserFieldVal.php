 ...
 *
 * @property \lispa\amos\community\models\CommunityUserField $userField
 * @property \lispa\amos\core\user\User $user
 */
class  CommunityUserFieldVal extends \lispa\amos\core\record\Record
{
    ...
    {
        return $this->hasOne(\lispa\amos\community\models\CommunityUserField::className(), ['id' => 'user_field_id']);
    }
