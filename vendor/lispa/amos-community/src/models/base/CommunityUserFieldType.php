 ...
 *
 * @property \lispa\amos\community\models\CommunityUserField[] $communityUserFields
 */
class  CommunityUserFieldType extends \lispa\amos\core\record\Record
{
    ...
    {
        return $this->hasMany(\lispa\amos\community\models\CommunityUserField::className(), ['user_field_type_id' => 'id']);
    }
}
