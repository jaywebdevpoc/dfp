            ...
            <div class="col-md-8 col xs-12">
               ...
               <?php  } else { ?>
                    <?= $form->field($model, 'community_id')->widget(Select::classname(), [
                        'data' => ArrayHelper::map(\lispa\amos\community\models\Community::find()->asArray()->all(), 'id', 'name'),
                ...
                'data' => ArrayHelper::map(\lispa\amos\community\models\CommunityUserFieldType::find()->asArray()->all(),'id','description'),
                'language' => substr(Yii::$app->language, 0, 2),
                'pluginOptions' => [
                    'allowClear' => true
                ],
