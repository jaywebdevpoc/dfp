...
$isModalContexts = [
    \lispa\amos\community\models\Community::className()
];
/** @var AmosAdmin $adminModule */
$adminModule = AmosAdmin::instance();
$organizzazioniModuleName = $adminModule->getOrganizationModuleName();
/** @var OrganizationsModuleInterface $organizzazioniModule */
$organizzazioniModule = Yii::$app->getModule($organizzazioniModuleName);
if (!is_null($organizzazioniModule)) {
    $isModalContexts[] = $organizzazioniModule->getOrganizationModelClass();
}
