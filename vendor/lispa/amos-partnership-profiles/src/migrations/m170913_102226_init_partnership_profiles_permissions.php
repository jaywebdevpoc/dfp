...
use lispa\amos\core\rules\UserValidatorContentRule;
use lispa\amos\core\rules\ValidatorUpdateContentRule;
...
use lispa\amos\partnershipprofiles\rules\DeleteOwnExprOfIntRule;
use lispa\amos\partnershipprofiles\rules\DeleteOwnPartnershipProfilesRule;
...
use lispa\amos\partnershipprofiles\rules\UpdateOwnExprOfIntRule;
use lispa\amos\partnershipprofiles\rules\UpdateOwnPartnershipProfilesRule;
...
class m170913_102226_init_partnership_profiles_permissions extends AmosMigrationPermissions
{
    ...
    private function setWidgetsPermissions()
    {
        ...
        return [
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesAllAdmin::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnershipProfilesAllAdmin',
                'parent' => ['PARTNERSHIP_PROFILES_ADMINISTRATOR']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesDashboard::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesOwnInterest::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnershipProfilesOwnInterest',
                'parent' => ['PARTNERSHIP_PROFILES_ADMINISTRATOR', 'PARTNERSHIP_PROFILES_READER']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesAll::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnershipProfilesAll',
                'parent' => ['PARTNERSHIP_PROFILES_ADMINISTRATOR', 'PARTNERSHIP_PROFILES_READER']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesCreatedBy::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnershipProfilesCreatedBy',
                'parent' => ['PARTNERSHIP_PROFILES_ADMINISTRATOR', 'PARTNERSHIP_PROFILES_CREATOR']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesToValidate::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesArchived::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnershipProfilesArchived',
                'parent' => ['PARTNERSHIP_PROFILES_ADMINISTRATOR', 'PARTNERSHIP_PROFILES_READER']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnershipProfilesClosed::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconExpressionsOfInterestAllAdmin::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconExpressionsOfInterestAllAdmin',
                'parent' => ['EXPRESSIONS_OF_INTEREST_ADMINISTRATOR']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconExpressionsOfInterestDashboard::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconExpressionsOfInterestReceived::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnerProfExprOfIntDashboard::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnerProfExprOfIntDashboard',
                'parent' => ['PARTNER_PROF_EXPR_OF_INT_ADMIN_FACILITATOR']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnerProfExprOfIntPartProf::className(),
                'type' => Permission::TYPE_PERMISSION,
                'description' => $prefixStr . 'WidgetIconPartnerProfExprOfIntPartProf',
                'parent' => ['PARTNER_PROF_EXPR_OF_INT_ADMIN_FACILITATOR']
            ],
            [
                'name' => \lispa\amos\partnershipprofiles\widgets\icons\WidgetIconPartnerProfExprOfIntExprOfInt::className(),
                'type' => Permission::TYPE_PERMISSION,
