...
use lispa\amos\partnershipprofiles\models\WorkLanguage;
use yii\base\Model;
use yii\data\ActiveDataProvider;

/**
 * Class WorkLanguageSearch
 * WorkLanguageSearch represents the model behind the search form about `lispa\amos\partnershipprofiles\models\WorkLanguage`.
 * @package lispa\amos\partnershipprofiles\models\search
 */
