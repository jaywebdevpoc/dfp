 ...
 *
 *
 * @package    lispa\amos\partnershipprofiles\models\search
 * @category   CategoryName
 */

namespace lispa\amos\partnershipprofiles\models\search;

use lispa\amos\partnershipprofiles\models\PartnershipProfilesType;
use yii\base\Model;
use yii\data\ActiveDataProvider;

/**
 * Class PartnershipProfilesTypeSearch
 * PartnershipProfilesTypeSearch represents the model behind the search form about `lispa\amos\partnershipprofiles\models\PartnershipProfilesType`.
 * @package lispa\amos\partnershipprofiles\models\search
 */
