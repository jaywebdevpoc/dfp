 ...
 * @property \lispa\amos\comuni\models\IstatNazioni[] $countries
 *
 * @package lispa\amos\partnershipprofiles\models\base
 */
class PartnershipProfilesCountriesMm extends Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['country_id'], 'exist', 'skipOnError' => true, 'targetClass' => \lispa\amos\comuni\models\IstatNazioni::className(), 'targetAttribute' => ['country_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\PartnershipProfiles::className(), ['id' => 'partnership_profile_id']);
    }
