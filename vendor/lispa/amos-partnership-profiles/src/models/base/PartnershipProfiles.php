 ...
 *
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $expressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $draftExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $activeExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $toValidateExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $relevantExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $rejectedExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest[] $notDraftExpressionsOfInterest
 * @property \lispa\amos\partnershipprofiles\models\WorkLanguage $workLanguage
 * @property \lispa\amos\partnershipprofiles\models\DevelopmentStage $developmentStage
 * @property \lispa\amos\partnershipprofiles\models\IntellectualProperty $intellectualProperty
 * @property \lispa\amos\partnershipprofiles\models\PartnershipProfilesTypesMm[] $partnershipProfilesTypesMms
 * @property \lispa\amos\partnershipprofiles\models\PartnershipProfilesCountriesMm[] $partnershipProfilesCountriesMms
 * @property \lispa\amos\partnershipprofiles\models\PartnershipProfilesType[] $partnershipProfilesTypes
 * @property \lispa\amos\comuni\models\IstatNazioni[] $partnershipProfileCountries
 * @property \lispa\amos\admin\models\UserProfile $partnershipProfileFacilitator
...
class PartnershipProfiles extends NotifyRecord implements CommunityInterface
{
    ...
    {
        return $this->hasOne(\lispa\amos\partnershipprofiles\models\WorkLanguage::className(), ['id' => 'work_language_id']);
    }
    ...
    {
        return $this->hasOne(\lispa\amos\partnershipprofiles\models\DevelopmentStage::className(), ['id' => 'development_stage_id']);
    }
    ...
    {
        return $this->hasOne(\lispa\amos\partnershipprofiles\models\IntellectualProperty::className(), ['id' => 'intellectual_property_id']);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\PartnershipProfilesTypesMm::className(), ['partnership_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\PartnershipProfilesType::className(), ['id' => 'partnership_profiles_type_id'])->via('partnershipProfilesTypesMms');
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\PartnershipProfilesCountriesMm::className(), ['partnership_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\comuni\models\IstatNazioni::className(), ['id' => 'country_id'])->via('partnershipProfilesCountriesMms');
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id'])
            ->andWhere([\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_DRAFT]);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id'])
            ->andWhere([\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_ACTIVE]);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id'])
            ->andWhere([\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_TOVALIDATE]);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id'])
            ->andWhere([\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_RELEVANT]);
    }
    ...
    {
        return $this->hasMany(\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::className(), ['partnership_profile_id' => 'id'])
            ->andWhere([\lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_REJECTED]);
    }
