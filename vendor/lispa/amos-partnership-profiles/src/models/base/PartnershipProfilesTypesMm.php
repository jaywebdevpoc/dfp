 ...
 *
 * @property \lispa\amos\partnershipprofiles\models\PartnershipProfiles $partnershipProfile
 * @property \lispa\amos\partnershipprofiles\models\PartnershipProfilesType $partnershipProfilesType
 *
 * @package lispa\amos\partnershipprofiles\models\base
 */
class PartnershipProfilesTypesMm extends Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['partnership_profile_id'], 'exist', 'skipOnError' => true, 'targetClass' => \lispa\amos\partnershipprofiles\models\PartnershipProfiles::className(), 'targetAttribute' => ['partnership_profile_id' => 'id']],
            [['partnership_profiles_type_id'], 'exist', 'skipOnError' => true, 'targetClass' => \lispa\amos\partnershipprofiles\models\PartnershipProfilesType::className(), 'targetAttribute' => ['partnership_profiles_type_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(\lispa\amos\partnershipprofiles\models\PartnershipProfiles::className(), ['id' => 'partnership_profile_id']);
    }
    ...
    {
        return $this->hasOne(\lispa\amos\partnershipprofiles\models\PartnershipProfilesType::className(), ['id' => 'partnership_profiles_type_id']);
    }
}
