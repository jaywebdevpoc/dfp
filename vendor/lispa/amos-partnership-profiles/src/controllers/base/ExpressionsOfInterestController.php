 ...
 *
 *
 * @package    lispa\amos\partnershipprofiles\controllers\base
 * @category   CategoryName
 */

namespace lispa\amos\partnershipprofiles\controllers\base;
...
use lispa\amos\partnershipprofiles\events\PartnershipProfilesWorkflowEvent;
 ...
 *
 * @property \lispa\amos\partnershipprofiles\models\ExpressionsOfInterest $model
 * @property \lispa\amos\partnershipprofiles\models\search\ExpressionsOfInterestSearch $modelSearch
 *
 * @package lispa\amos\partnershipprofiles\controllers\base
 */
    ...
    public function actionCreate($partnership_profile_id = null)
    {
        ...
        if ($this->model->load(Yii::$app->request->post())) {
            ...
            if (!is_null($moduleCwh)) {
                ...
                $cwhConfig = \lispa\amos\cwh\models\CwhConfig::findOne(['tablename' => $splitUserNetworkReference[0]]);
