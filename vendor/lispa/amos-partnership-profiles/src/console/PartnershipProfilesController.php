 ...
 *
 *
 * @package    lispa\amos\partnershipprofiles\controllers\console
 * @category   CategoryName
 */

namespace lispa\amos\partnershipprofiles\console;

use lispa\amos\core\user\User;
use lispa\amos\partnershipprofiles\models\PartnershipProfiles;
use lispa\amos\partnershipprofiles\Module;
use lispa\amos\partnershipprofiles\utility\PartnershipProfilesEmailUtility;
...
class PartnershipProfilesController extends Controller
{
    ...
    public function actionArchivePartnershipProfiles()
    {
        ...
        $text = $this->renderPartial("@vendor/lispa/amos-partnership-profiles/src/views/expressions-of-interest/email/admin_notify_content", [
