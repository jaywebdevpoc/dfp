...
/**
 * This is the base-model class for table "protezione_innovazione_risultati".
 *
 * @property integer $id
 ...
 */
class ProtezioneInnovazioneRisultati extends \lispa\amos\core\record\Record
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'protezione_innovazione_risultati';
    }
    ...
    {
        return $this->hasMany(\lispa\amos\risultati\models\RisultatiProtezioneInnovazioneRisultatiMm::className(), ['protezione_innovazione_risultati_id' => 'id'])->inverseOf('protezioneInnovazioneRisultati');
    }
}
