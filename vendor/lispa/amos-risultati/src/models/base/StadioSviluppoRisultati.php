...
/**
 * This is the base-model class for table "stadio_sviluppo_risultati".
 *
 * @property integer $id
 ...
 */
class StadioSviluppoRisultati extends \lispa\amos\core\record\Record
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stadio_sviluppo_risultati';
    }
    ...
    {
        return $this->hasMany(\lispa\amos\risultati\models\RisultatiStadioSviluppoRisultatiMm::className(), ['stadio_sviluppo_risultati_id' => 'id'])->inverseOf('stadioSviluppoRisultati');
    }
}
