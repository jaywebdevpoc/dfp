...
/**
 * This is the base-model class for table "tecnologie_risultati".
 *
 * @property integer $id
 ...
 */
class TecnologieRisultati extends \lispa\amos\core\record\Record
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(\lispa\amos\risultati\models\RisultatiTecnologieRisultatiMm::className(), ['tecnologie_risultati_id' => 'id'])->inverseOf('tecnologieRisultati');
    }
}
