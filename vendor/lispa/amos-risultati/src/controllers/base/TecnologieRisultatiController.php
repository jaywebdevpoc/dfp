...
use lispa\amos\risultati\models\search\TecnologieRisultatiSearch;
 ...
 */
class TecnologieRisultatiController extends CrudController
{
    /**
    ...
    public function init()
    {
        ...
        $this->setModelObj(new TecnologieRisultati());
        $this->setModelSearch(new TecnologieRisultatiSearch());
     ...
     * @param integer $id
     * @return TecnologieRisultati the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TecnologieRisultati::findOne($id)) !== null) {
            return $model;
        } else {
