...
use lispa\amos\risultati\models\search\BisognoPerSviluppoRisultatiSearch;
use Yii;
use yii\helpers\Url;
use yii\web\NotFoundHttpException;

/**
 * Class BisognoPerSviluppoRisultatiController
 * BisognoPerSviluppoRisultatiController implements the CRUD actions for BisognoPerSviluppoRisultati model.
 * @package lispa\amos\risultati\controllers\base
 */
class BisognoPerSviluppoRisultatiController extends CrudController
{
    /**
    ...
    public function init()
    {
        ...
        $this->setModelObj(new BisognoPerSviluppoRisultati());
        $this->setModelSearch(new BisognoPerSviluppoRisultatiSearch());
    ...
    /**
     * Lists all BisognoPerSviluppoRisultati models.
     * @return mixed
     */
    ...
    /**
     * Displays a single BisognoPerSviluppoRisultati model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the BisognoPerSviluppoRisultati model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BisognoPerSviluppoRisultati the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BisognoPerSviluppoRisultati::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Creates a new BisognoPerSviluppoRisultati model.
    ...
    public function actionCreate()
    {
        ...
        $model = new BisognoPerSviluppoRisultati;
    ...
    /**
     * Creates a new BisognoPerSviluppoRisultati model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    ...
    /**
     * Updates an existing BisognoPerSviluppoRisultati model.
    ...
    /**
     * Deletes an existing BisognoPerSviluppoRisultati model.
