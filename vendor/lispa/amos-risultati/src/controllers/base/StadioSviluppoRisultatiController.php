...
use lispa\amos\risultati\models\search\StadioSviluppoRisultatiSearch;
...
/**
 * Class StadioSviluppoRisultatiController
 * StadioSviluppoRisultatiController implements the CRUD actions for StadioSviluppoRisultati model.
 * @package lispa\amos\risultati\controllers\base
 */
class StadioSviluppoRisultatiController extends CrudController
{
    /**
    ...
    public function init()
    {
        ...
        $this->setModelObj(new StadioSviluppoRisultati());
        $this->setModelSearch(new StadioSviluppoRisultatiSearch());
    ...
    /**
     * Lists all StadioSviluppoRisultati models.
     * @return mixed
     */
    ...
    /**
     * Displays a single StadioSviluppoRisultati model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the StadioSviluppoRisultati model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return StadioSviluppoRisultati the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = StadioSviluppoRisultati::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Creates a new StadioSviluppoRisultati model.
    ...
    public function actionCreate()
    {
        ...
        $model = new StadioSviluppoRisultati;
    ...
    /**
     * Creates a new StadioSviluppoRisultati model by ajax request.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    ...
    /**
     * Updates an existing StadioSviluppoRisultati model.
    ...
    /**
     * Deletes an existing StadioSviluppoRisultati model.
