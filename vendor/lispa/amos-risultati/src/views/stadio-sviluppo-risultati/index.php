...
$this->title = AmosRisultati::t('amosrisultati', 'Stadio Sviluppo Risultati');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="stadio-sviluppo-risultati-index">
    <?php echo $this->render('_search', ['model' => $model]); ?>

    <p>
        <?php /* echo         Html::a('Nuovo Stadio Sviluppo Risultati'        , ['create'], ['class' => 'btn btn-amministration-primary'])*/ ?>
    </p>
