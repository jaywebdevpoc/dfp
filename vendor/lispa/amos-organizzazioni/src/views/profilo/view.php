...
if (!$communityPresent) {
    if (in_array(\Yii::$app->user->id, [$model->rappresentante_legale, $model->referente_operativo])) {
        $button['title'] = Module::t('amosorganizzazioni', 'Crea una community associata<br />a questa organizzazione');
