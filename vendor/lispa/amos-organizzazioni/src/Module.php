...
//                $org->status = ($this->enableConfirmUsersJoinRequests ? $profiloUserMm::STATUS_WAITING_REQUEST_CONFIRM : $profiloUserMm::STATUS_WAITING_OK_USER); // TODO mettere questo quando sarà finita la modifica per la conferma dell'invito da parte dell'utente invitato
