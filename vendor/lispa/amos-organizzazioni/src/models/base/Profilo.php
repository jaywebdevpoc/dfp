 ...
 * @property \lispa\amos\organizzazioni\models\ProfiloTipoStruttura $tipologiaStruttura
 *
 * @package lispa\amos\organizzazioni\models\base
 */
abstract class Profilo extends NetworkModel
{
    ...
    {
        return $this->hasOne(Module::instance()->createModel('ProfiloTipoStruttura')->className(), ['id' => 'tipologia_struttura_id']);
    }
}
