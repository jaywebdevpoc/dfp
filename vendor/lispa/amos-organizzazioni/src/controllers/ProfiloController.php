...
class ProfiloController extends base\ProfiloController
{
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'roles' => ['MANAGER_ORGANIZZAZIONE', 'ADMIN']
                    ],
    ...
    /**
     * 
     * @param type $id Profilo Organizzazione id
     * 
     * @return type
     */
    public function actionCreateCommunity($id = null) 
    {
        ...
        if (is_null($model->community_id)) {
            ...
            if ($model->save(false)) {
                if ($ok) {
                    Yii::$app->getSession()->addFlash('success', Module::t('amosorganizzazioni', 'Community successfully created.'));
                } else {
                    Yii::$app->getSession()->addFlash('danger', Module::t('amosorganizzazioni', 'There was an error while saving.'));
                }
            }
        }
