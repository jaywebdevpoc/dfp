...
class Google_Service_Books_Resource_Myconfig extends Google_Service_Resource
{
   ...
   */
  public function syncVolumeProscriptions($source, $nonce, $cpksver, $optParams = array())
  {
    $params = array('source' => $source, 'nonce' => $nonce, 'cpksver' => $cpksver);
    $params = array_merge($params, $optParams);
    return $this->call('syncVolumeProscriptions', array($params), "Google_Service_Books_Volumes");
  }
  /**
