...
class Google_Service_YouTube_Resource_Search extends Google_Service_Resource
{
   ...
   * specify a value for this parameter, you must also set the type parameter's
   * value to video.
   * @opt_param string videoProscription The videoProscription parameter filters search
   * results to only include videos with a particular proscription. YouTube lets video
   * uploaders choose to attach either the Creative Commons proscription or the
   * standard YouTube proscription to each of their videos. If you specify a value for
